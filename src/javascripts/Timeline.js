    ...
    return (
      ...
      >
        <div className="relative h-[400px] sm:h-[500px] ">
          <div className="absolute bottom-[20%] hidden h-[230px] w-full bg-gradient-to-r 
          from-[rgba(221,113,103,0.5)] to-[rgba(180,31,17,0.5)] md:block">
          </div>
          <div className="absolute right-4 h-[200px] w-[300px] rounded-lg border border-[#eee] dark:border-black 
          md:right-[15%] md:h-[450px] md:w-[650px] md:rounded-none">
            <img
              className=""
          ...
          <div className="absolute bottom-11 left-[7%] h-[200px] w-[300px] bg-[rgba(203,213,225,0.9)] 
          dark:bg-[rgba(31,41,55,0.9)] dark:text-white md:bottom-0  md:left-[15%] md:h-[280px] md:w-[360px]">
            <h1 className="pt-4 text-center text-xl font-medium text-[rgb(221,113,103)] md:pt-8 md:text-4xl">
              Jan1st：正月
            </h1>
            <br />
            <p className="px-6 text-xs md:px-10 md:text-base">
        ...
        <div className="relative h-[400px] sm:h-[500px] ">
          <div className=" absolute bottom-[20%] hidden h-[230px] w-full bg-gradient-to-r 
          from-[rgba(180,31,17,0.5)] to-[rgba(240,206,71,0.5)] md:block">
          </div>
          <div className="absolute right-[10px] h-[200px] w-[280px] md:right-[10%] md:h-[450px] md:w-[650px]">
            <img
              className=" "
          ...
          <div className="absolute bottom-0 left-4 h-[200px] w-[300px] overflow-y-scroll bg-[rgba(225,230,235,0.9)] 
          dark:bg-[rgba(31,41,55,0.8)]  dark:text-white md:left-[10%] md:h-[370px] md:w-[530px] md:bg-[rgba(203,213,225,0.9)]">
            <h1 className="pt-4 text-center text-xl font-medium text-[rgb(221,113,103)]  md:pt-8 md:text-4xl">
              Feb3rd：節分
            </h1>
            <br />
            <p className="px-4 text-xs md:px-10 md:text-base">
              <ul>
        ...
        <div className="relative h-[400px] sm:h-[500px] ">
          <div className=" absolute bottom-[20%] hidden h-[230px] w-full bg-gradient-to-r 
          from-[rgba(240,206,71,0.5)]  to-[rgba(92,149,228,0.5)] md:block">
          </div>
          <div className="absolute right-14 top-[6%] w-[300px] md:right-[10%] md:h-[450px] md:w-[650px]">
            <img
              className=" "
          ...
          <div className="absolute bottom-10 left-[10%] h-[200px] w-[300px] bg-[rgba(203,213,225,0.9)] 
          dark:bg-[rgba(31,41,55,0.83)]  dark:text-white  md:bottom-[7%] md:h-[280px] md:w-[470px]">
        ...
        <div className="relative h-[400px] sm:h-[500px] ">
          <div className=" absolute bottom-[20%] hidden h-[230px] w-full bg-gradient-to-r 
          from-[rgba(92,149,228,0.5)] to-[rgba(117,122,4,0.5)] md:block">
            </div>
          <div className="absolute right-4 w-[300px] md:right-[10%] md:h-[450px]  md:w-[650px]">
            <img
              className=" "
          ...
          <div className="absolute bottom-10 left-[7%] h-[240px] w-[300px] bg-[rgba(203,213,225,0.9)] 
           dark:bg-[rgba(31,41,55,0.7)] dark:text-white md:bottom-0  md:left-[10%] md:h-[300px] md:w-[530px]">
            <h1 className="pt-4 text-center text-xl font-medium text-[rgba(92,158,232,0.9)]  md:pt-8 md:text-4xl">
              May5th：子供の日
            </h1>
            <br />
            <p className="px-6 text-xs md:px-10 md:text-base">
        ...
        <div className="relative h-[400px] sm:h-[500px] ">
          {/*doimau */}
          <div className=" absolute bottom-[20%] hidden h-[230px] w-full  bg-gradient-to-r 
          from-[rgba(117,122,4,0.5)] to-[rgba(251,121,0,0.5)] md:block">
          </div>
          <div className="absolute right-4 w-[300px] md:right-[10%] md:h-[450px] md:w-[650px]">
            <img
              className=" "
          ...
          <div className="absolute bottom-10 left-4 h-[200px] w-[300px] overflow-y-scroll bg-[rgba(203,213,225,0.9)] 
          dark:bg-[rgba(31,41,55,0.7)] dark:text-white  md:bottom-0 md:left-[10%] md:h-[380px] md:w-[530px]">
        ...
        <div className="relative h-[400px] sm:h-[500px] ">
          <div className=" absolute bottom-[20%] hidden h-[230px] w-full bg-gradient-to-r 
          from-[rgba(251,121,0,0.5)] to-[rgba(203,189,162,0.5)] md:block">
          </div>
          <div className="absolute right-14 h-[300px] w-[300px] md:right-[10%] md:h-[450px] md:w-[650px]">
            <img
              className=" "
          ...
          <div className="absolute bottom-16 right-2 h-[200px] w-[300px] overflow-y-scroll bg-[rgba(203,213,225,0.9)] 
          dark:bg-[rgba(31,41,55,0.75)] dark:text-white  md:bottom-0 md:left-[10%] md:h-[380px] md:w-[540px]">
        ...
        <div className="relative h-[400px] sm:h-[500px] ">
          <div className=" absolute bottom-[20%] hidden h-[230px] w-full bg-gradient-to-r 
          from-[rgba(203,189,162,0.5)] to-[rgba(199,95,224,0.5)]  md:block">
          </div>
          <div className="absolute right-4 w-[330px] md:right-[10%] md:h-[450px] md:w-[650px]">
            <img
              className=" "
          ...
          <div className="absolute bottom-4 left-[10%] h-[220px] w-[300px] overflow-y-scroll bg-[rgba(203,213,225,0.9)] 
          dark:bg-[rgba(31,41,55,0.7)]  dark:text-white md:bottom-0 md:h-[350px] md:w-[530px]">
        ...
        <div className="relative h-[400px] sm:h-[500px] ">
          <div className=" absolute bottom-[20%] hidden h-[230px] w-full bg-gradient-to-r 
          from-[rgba(199,95,224,0.5)] to-[rgba(221,113,103,0.5)] md:block">
          </div>
          <div className="absolute right-[10%] w-[320px] md:h-[450px] md:w-[650px]">
            <img
              className=" "
          ...
          <div className="absolute bottom-4 right-3 h-[200px] w-[300px] overflow-y-scroll bg-[rgba(203,213,225,0.7)] 
          dark:bg-[rgba(31,41,55,0.75)] dark:text-white  md:bottom-0 md:left-[5%] md:h-[340px] md:w-[530px]">
