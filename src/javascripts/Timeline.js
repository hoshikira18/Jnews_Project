  ...
  render() {
    return (
      <BindKeyboardSwipeableViews
        ...
        enableMouseEvents
      >
        <div className=" flex lg:h-[500px] md:h-[600px] h-[700px]">
          ...
          <div className="w-2/5 dark:bg-gray-800 dark:text-white bg-slate-100">
            <h1 className="font-medium text-center lg:text-2xl md:text-3xl text-4xl pt-8">Jan1st：正月</h1>
            <br />
            <p className="pl-10 pr-10 text-2xl md:text-base">
        ...
        <div className=" flex lg:h-[500px] md:h-[600px] h-[700px]">
          ...
          <div className="w-2/5 dark:bg-gray-800 dark:text-white bg-slate-100">
            <h1 className="font-medium text-center lg:text-2xl md:text-3xl text-4xl pt-8">Feb3rd：節分</h1>
            <br />
            <p className="pl-10 text-2xl md:text-base pr-10">
              <ul>
        ...
        <div className=" flex lg:h-[500px] md:h-[600px] h-[700px]">
          ...
          <div className="w-2/5 dark:bg-gray-800 dark:text-white bg-slate-100">
            <h1 className="font-medium text-center lg:text-2xl md:text-3xl text-4xl pt-8">Mar3rd：ひな祭り</h1>
            <br />
            <p className="pl-10 text-2xl md:text-base pr-10">
        ...
        <div className=" flex lg:h-[500px] md:h-[600px] h-[700px]">
          ...
          <div className="w-2/5 dark:bg-gray-800 dark:text-white bg-slate-100">
            <h1 className="font-medium text-center lg:text-2xl md:text-3xl text-4xl pt-8">May5th：子供の日</h1>
            <br />
            <p className="pl-10 text-2xl md:text-base pr-10">
        ...
        <div className=" flex lg:h-[500px] md:h-[600px] h-[700px]">
          ...
          <div className="w-2/5 dark:bg-gray-800 dark:text-white bg-slate-100">
            <h1 className="font-medium text-center lg:text-2xl md:text-3xl text-4xl pt-8">Jul7th：七夕</h1>
            <br />
            <p className="pl-10 text-2xl md:text-base pr-10">
              <ul>
        ...
        <div className=" flex lg:h-[500px] md:h-[600px] h-[700px]">
          ...
          <div className="w-2/5 dark:bg-gray-800 dark:text-white bg-slate-100">
            <h1 className="font-medium text-center lg:text-2xl md:text-3xl text-4xl pt-8">Jul15th：お盆</h1>
            <br />
            <p className="pl-10 text-2xl md:text-base pr-10">
        ...
        <div className=" flex lg:h-[500px] md:h-[600px] h-[700px]">
          ...
          <div className="w-2/5 dark:bg-gray-800 dark:text-white bg-slate-100">
            <h1 className="font-medium text-center lg:text-2xl md:text-3xl text-4xl pt-8">
        ...
        <div className=" flex lg:h-[500px] md:h-[600px] h-[700px]">
          ...
          <div className="w-2/5 dark:bg-gray-800 dark:text-white bg-slate-100">
            <h1 className="font-medium text-center lg:text-2xl md:text-3xl text-4xl pt-8">Nov15th：七五三</h1>
            <br />
            <p className="pl-10 text-2xl md:text-base pr-10">
