    ...
    <div className="slide rounded overflow-hidden relative">
      <div className="dieuhuong text-6xl flex ">
        <div
          ...
          dark:text-black hover:scale-125 bg-opacity-50 hover:text-blue-700 z-50 "
          onClick={Back}
        >
          <AiOutlineDoubleLeft />
        </div>
        <div
          ...
          dark:text-black hover:scale-125 hover:text-blue-700 bg-opacity-50 z-50  "
          onClick={Next}
        >
      ...
      <div className="chuyen-slide w-[7000px] float-left flex transition-all ease-in duration-500 ">
        ...
        <div className=" flex w-[1252px] h-[520px] relative">
          ...
          <div className="w-[550px] h-[350px] absolute bg-[rgb(67,126,156)] bottom-10 right-[7vw] rounded-[30px]">
            <h1 className="text-center dark:text-white font-bold text-2xl pt-4 pb-3">
            甚平
            </h1>
            <p className="px-8 dark:text-white">
        ...
        <div className=" flex w-[1252px] h-[520px] relative">
          <div className="w-[550px] h-[350px] absolute top-14 right-[13vw] ">
            <img
          ...
          <div className="w-[550px] h-[350px] absolute bg-[rgb(247,147,176)] bottom-6 left-[10vw] rounded-[30px]">
            <h1 className="text-center dark:text-white font-bold text-2xl pt-4 pb-3">
            着物
            </h1>
            <p className="px-8 dark:text-white">
