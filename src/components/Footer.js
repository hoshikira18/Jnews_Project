    ...
    <footer className="bg-black p-4 sm:p-6">
      <div className="md:flex md:justify-between md:pl-10">
        ...
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 text-white lg:gap-x-32">
          <div>
            <h2 className="text-sm font-semibold text-white uppercase mb-6">
              Members
            </h2>
      ...
      <div className="grid lg:grid-cols-3 grid-cols-2">
        <span className="sm:text-center text-sm text-gray-400">
          © 2023{" "}
          <a href="" className="hover:underline">
            Team5™
          </a>
        ...
        <div>
          <h1 className="text-gray-400 font-semibold text-sm text-center">
