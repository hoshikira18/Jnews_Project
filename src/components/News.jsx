        ...
        <div className="h-[200px] w-full my-3 bg-cyan-200 dark:bg-sky-700"> 
            <div className=" transition-all flex h-[200px] w-full bg-slate-100 my-3 py-3 border-[2px] border-slate-300 drop-shadow-xl dark:bg-gray-700 dark:border-slate-500 hover:translate-x-2 hover:translate-y-[-8px]" > {/* bỏ absolute*/} 
                ...
                <div className="flex flex-col justify-between w-[500px] mx-3">
                    <h1 className="font-bold text-xl dark:text-slate-100 hover:drop-shadow-2xl" >Khoe tặng Xemesis “quà khủng” - thứ xin mua 3 tháng mà chưa cho nhưng nhan sắc Xoài Non lại giật hết spotlight</h1>
                    <div>
                        <h3 className="inline font-semibold text-sm dark:text-slate-200 "> Đời sống - </h3>
                        <h3 className="inline text-sm text-opacity-75 text-slate-600 dark:text-slate-300"> 1 giờ trước </h3>
                    </div>
