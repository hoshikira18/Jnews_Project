...
export default function () {
  ...
  return (
    ...
    <div className="sm:h-[120px] md:h-[200px] w-full my-3 bg-cyan-200 dark:bg-sky-700">
      <div
        className=" transition-all flex sm:h-[120px] md:h-[200px] w-full bg-slate-100 my-3 py-3 border-[2px] border-slate-300 
      ...
      >
        ...
        <div className="flex flex-col justify-between max-w-[470px] max-h-full mx-3">
          <h1 className="font-bold sm:text-sm md:text-xl dark:text-slate-100 hover:drop-shadow-2xl">
            Khoe tặng Xemesis “quà khủng” - thứ xin mua 3 tháng mà chưa cho
            nhưng nhan sắc Xoài Non lại giật hết spotlight
          </h1>
          <div>
            <h3 className="inline sm:font-medium sm:text-xs md:font-semibold md:text-sm dark:text-slate-200 ">
              {" "}
              Đời sống -{" "}
            </h3>
            <h3 className="inline sm:text-xs md:text-sm text-opacity-75 text-slate-600 dark:text-slate-300">
              {" "}
              1 giờ trước{" "}
            </h3>
          </div>
          <p className="sm:text-xs md:text-sm dark:text-slate-300 overflow-hidden bg-gradient-to-b from-[rgba(255,255,255,0.1)] to-[rgba(255,255,255,0.8)] relative">
