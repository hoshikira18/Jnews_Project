    ...
    <div className="background h-96 w-full bg-white dark:bg-gray-900 flex justify-center items-center overflow-x-scroll lg:overflow-hidden">
      <div className="card-1 mx-4 md:ml-96 lg:ml-0" responsive>
        ...
        >
          ...
          ></div>
          <div className="item-text z-20 transition-all duration-200 text-white w-28 ml-[47.5%] font-bold text-lg text-left absolute inset-x-0 bottom-0 origin-left -rotate-90">
            おにぎり 
          </div>
          <p className="info transition-all duration-200 z-10  w-[284px] text-white text-sm font-extralight absolute top-[55%] mx-[5%] hidden">
            おにぎりは日本でとてもポピュラーな食べ物です。「おむすび」や「握り飯」とも呼ばれ、お弁当などによく用いられます。
          </p>
          <div className="background transition-all duration-200 z-0 w-full h-[70%] rounded-[15px] bg-gradient-to-b from-[rgba(255,255,255,0)] to-[rgba(55,26,26,0.95)] bottom-0 hidden absolute"></div>
        </div>
      </div>
      ...
      <div className="card-2 mx-4" responsive>
        ...
        >
          ...
          <p className="info transition-all duration-200 z-10 w-[284px] text-white text-sm font-extralight absolute top-[55%] left-[5%] hidden">
            食酢で味つけした飯(めし)に魚貝などを添えた料理、あるいは塩押しした魚を漬け込んで自然発酵させたものをいう。
          </p>
          <div
            className="background transition-all duration-200 z-0 w-full h-[70%] rounded-[15px] bg-gradient-to-b
      ...
      <div className="card-5 mx-4 " responsive>
        ...
        >
          <div
            ...
            onMouseLeave={returncard}
          ></div>
          <div className="item-text z-20 transition-all duration-200 text-white w-32 ml-[47.5%] font-bold text-lg text-left absolute inset-x-0 bottom-0 origin-left -rotate-90">
            刺身
          </div>
          <p className="info transition-all duration-200 z-10 w-[284px] text-white text-sm font-extralight absolute top-[55%] left-[5%] hidden">
          ...
          <div
            className="background transition-all duration-200 z-0 w-full h-[70%] rounded-[15px]
