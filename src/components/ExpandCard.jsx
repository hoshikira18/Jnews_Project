...
// import responsive from "../javascripts/cardresponsive";
function ExpandCard() {
  return (
    <div className="background h-96 w-full flex justify-center items-center overflow-x-scroll">
      <div className="card-1 mx-4" responsive>
        <div
          className="item transition-all h-80 w-20 rounded-[25px] brightness-75 relative "
          style={{
            backgroundImage:
        ...
        >
          ...
          ></div>
          <div className="item-text z-20 transition-all text-white w-28 ml-[47.5%] font-bold text-lg text-left absolute inset-x-0 bottom-0 origin-left -rotate-90">
            おにぎり
          </div>
          <p className="info transition-all z-10  w-[284px] text-white text-sm font-extralight absolute top-[55%] mx-[5%] hidden">
      ...
      <div className="card-2 mx-4" responsive>
        ...
        >
          ...
          <p className="info transition-all z-10 w-[284px] text-white text-sm font-extralight absolute top-[55%] left-[5%] hidden">
      ...
      <div className="card-3 mx-4 " responsive>
        <div
          className="item transition-all h-80 w-20 rounded-[25px] brightness-75 relative"
          style={{
            backgroundImage:
        ...
        >
          <div
            ...
            onMouseLeave={returncard}
          ></div>
          <div className="item-text z-20 transition-all text-white w-32 ml-[47.5%] font-bold text-lg text-left absolute inset-x-0 bottom-0 origin-left -rotate-90">
            刺身 
          </div>
          <p className="info transition-all z-10 w-[284px] text-white text-sm font-extralight absolute top-[55%] left-[5%] hidden">
      ...
      <div className="card-4 mx-4" responsive>
        <div
          className="item transition-all h-80 w-20 rounded-[25px] brightness-75 relative "
          style={{
            backgroundImage:
      ...
      <div className="card-7 mx-4 block " responsive>
        <div
          className="item transition-all h-80 w-20 rounded-[25px] brightness-75 relative"
          style={{
            backgroundImage:
      ...
      <div className="card-8 mx-4 block " responsive>
        <div
          className="item transition-all h-80 w-20 rounded-[25px] brightness-75 relative"
          style={{
            backgroundImage:
      ...
      <div className="card-9 mx-4 hidden" responsive>
        <div
          className="item transition-all h-80 w-20 rounded-[25px] brightness-75  relative"
          style={{
            backgroundImage:
