      ...
      <div className="card-2 mx-4" responsive>
        ...
        >
          <div
            ...
            onMouseLeave={returncard}
          ></div>
          <div className="item-text z-20 transition-all text-white w-28 ml-[47.5%] font-bold lg:text-lg md:text-3xl text-6xl text-left absolute inset-x-0 bottom-0 origin-left -rotate-90">
            すし
          </div>
          <p className="info transition-all z-10 w-[284px] text-white lg:text-sm md:text-xl text-3xl font-extralight absolute top-[55%] left-[5%] hidden">
