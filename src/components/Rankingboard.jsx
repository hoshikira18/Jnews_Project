  ...
  return(
    <div class="w-auto h-auto mx-14 md:mx-7 lg:mx-0 pb-24 ">
      <div class="flex items-center w-full lg:w-[17rem] h-auto lg:h-10 justify-center pr-10 sm:pr-0">
       <img class="lg:w-8 lg:h-6 h-16 w-15 md:mx-2 mx-4" src="https://cdn-icons-png.flaticon.com/512/81/81460.png"/><span class="text-center lg:text-xl text-6xl md:text-4xl font-medium">Reading ranking</span>
      </div>
