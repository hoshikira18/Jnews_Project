      ...
      <div className="md:flex md:justify-between md:pl-10 pl-3">
        ...
        <div className="grid grid-cols-2 gap-1 sm:gap-3 md:gap-6 lg:grid-cols-3 dark:text-white lg:gap-x-[100px] pl-2">
          <div>
            ...
            <ul className='text-2xl sm:text-lg md:text-md dark:text-gray-400'>
              <li>Đức Hiệp</li>
              <li>Sơn Tùng</li>
              <li>Hồng Phong</li>
              <li>Mạnh Kiên</li>
          ...
          <div>
            ...
            <ul className='sm:text-lg text-xl md:text-md dark:text-gray-400'>
              <li className="mb-4">
          ...
          <div>
            ...
            <ul className='sm:text-lg md:text-md text-xl dark:text-gray-400's>
