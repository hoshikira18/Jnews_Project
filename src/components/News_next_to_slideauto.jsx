...
return(
    <div className='w-full lg:h-[500px] pb-5 px-3 hidden lg:block'>
        <div >
            <div class="relative ">
                <img className='w-full h-[500px]  border border-slate-700' src="https://www.surfertoday.com/images/stories/sunrisesunsettime.jpg" />
