    ...
    <div>
        <div className=" grid h-[450px] w-full grid-cols-2 gap-2 ">
          <div className="bg-blue-200  relative">
            <div className=" bottom-0 z-10 absolute pl-2 pr-2 h-[100px] bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] w-full  text-white">
            ...
            >
              <div className="overflow-hidden ">
                <div
                  ...
                  className=" h-[460px]  bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out "
                ></div>
              </div>
            </a>
          </div>
          <div className="grid grid-rows-2 gap-2">
            <div className="bg-blue-50 ">
              <div className="bg-blue-200  relative">
                <div className=" bottom-0 z-10 absolute pl-2 h-[50px] bg-gradient-to-t from-[rgba(164,13,126,0.5)] to-[rgba(240,191,224,0.2)] w-full   text-white">
                ...
                >
                  <div className="overflow-hidden ">
                    <div
                      ...
                      className=" h-[225px] bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                    ></div>
                  </div>
                </a>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-blue-200">
                <div className="bg-blue-200 relative">
                  <div className=" bottom-0 z-10 absolute pl-2  h-[50px] bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] w-full  text-white">
                    おもてなし日本の代表する文化
                  </div>
                  <a
                  ...
                  >
                    <div className="overflow-hidden ">
                      <div
                        ...
                        className="  h-[225px]  bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                      ></div>
                    </div>
                  </a>
                </div>
                ...
                >
                  <div className="overflow-hidden ">
                    <div
                      ...
                      className="  h-[230px] bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                    ></div>
                  </div>
                </a>
              </div>
              ...
              >
                <div className="overflow-hidden ">
                  <div
                    ...
                    className="  h-[470px] bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                  ></div>
                </div>
              </a>
            </div>
