    ...
    <div>
        <div className=" grid lg:h-[450px] h-auto w-full lg:grid-cols-2 grid-cols-1 lg:gap-2 gap-3 ">
          <div className="bg-blue-200  relative">
            <div className="bottom-0 z-10 absolute lg:pl-2 pl-3 lg:pr-2 pr-3 lg:h-[100px] md:h-[110px] h-[140px] lg:text-base md:text-xl text-3xl bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] w-full  text-white">
            ...
            >
              <div className="overflow-hidden ">
                <div
                  ...
                  className=" h-[660px] md:h-[460px]  bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out "
                ></div>
              </div>
            </a>
          </div>
          <div className="grid grid-rows-2 lg:gap-2 gap-3">
            <div className="bg-gray-900 ">
              <div className="bg-blue-200 w-full lg:h-auto md:h-[400px] h-[600px] relative">
                <div className=" bottom-0 z-10 absolute lg:pl-2 pl-4 lg:h-[50px] md:h-[65px] h-[100px] bg-gradient-to-t from-[rgba(164,13,126,0.5)] to-[rgba(240,191,224,0.2)] w-full lg:text-base md:text-xl text-3xl  text-white">
                ...
                >
                  <div className="overflow-hidden ">
                    <div
                      ...
                      className=" lg:h-[225px] md:h-[400px] h-[600px] bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                    ></div>
                  </div>
                </a>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2">
              <div className="bg-gray-900">
                <div className="bg-blue-200 relative">
                  <div className="bottom-0 z-10 absolute pl-2  lg:h-[50px] md:h-[65px] h-[100px] bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] w-full lg:text-base md:text-xl text-3xl  text-white">
                    おもてなし日本の代表する文化
                  </div>
                  <a
                  ...
                  >
                    <div className="overflow-hidden ">
                      <div
                        ...
                        className=" lg:h-[225px] md:h-[400px] h-[600px] bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                      ></div>
                    </div>
                  </a>
                </div>
                ...
                >
                  <div className="overflow-hidden ">
                    <div
                      ...
                      className=" lg:h-[230px] md:h-[410px] h-[620px] bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                    ></div>
                  </div>
                </a>
              </div>
              ...
              >
                <div className="overflow-hidden ">
                  <div
                    ...
                    className="  h-[660px] md:h-[470px] bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                  ></div>
                </div>
              </a>
            </div>
