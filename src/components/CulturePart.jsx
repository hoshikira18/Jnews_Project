    ...
    <div>
        <div className=" grid lg:h-[450px] h-auto w-full lg:grid-cols-2 grid-cols-1 lg:gap-2 gap-3 ">
          <div className="bg-blue-200  relative">
            <div className="bottom-0 z-10 absolute lg:pl-2 pl-3 lg:pr-2 pr-3 lg:h-[100px] md:h-[110px] h-[130px] lg:text-base md:text-xl text-3xl bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] w-full  text-white">
                ...
                >
                  <div className="overflow-hidden ">
                    <div
                      ...
                      className=" lg:h-[225px] h-[400px] bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                    ></div>
                  </div>
                </a>
              </div>
                  ...
                  >
                    <div className="overflow-hidden ">
                      <div
                        ...
                        className=" lg:h-[225px] h-[400px] bg-center bg-cover hover:scale-110 transition-all duration-500 ease-in-out bg-no-repeat"
                      ></div>
                    </div>
                  </a>
                </div>
        ...
        <div className=" grid lg:h-[450px] h-auto w-full lg:grid-cols-2 grid-cols-1 lg:gap-2 gap-3 mt-4">
          <div className="grid grid-rows-2 lg:gap-2 gap-3 ">
            <div className="bg-blue-50 ">
              <div className="bg-blue-200 relative">
                <div className=" bottom-0 z-10 absolute lg:pl-2 pl-4 lg:h-[80px] md:h-[100px] h-[115px] bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] w-full lg:text-base md:text-xl text-3xl  text-white">
