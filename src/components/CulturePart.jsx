...
export default function CulturePart() {
  return (
    <div>
      <div className=" grid h-[450px] w-full grid-cols-2 gap-2 ">
        <div className="relative  bg-blue-200">
          <div className=" absolute bottom-0 z-10 h-[100px] w-full bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] pl-2 pr-2  text-white">
          ...
          >
            <div className="overflow-hidden ">
              <div
                ...
                className=" h-[460px]  bg-cover bg-center transition-all duration-500 ease-in-out hover:scale-110 "
              ></div>
            </div>
          </a>
        </div>
        <div className="grid grid-rows-2 gap-2">
          <div className="bg-gray-900 ">
            <div className="relative  bg-blue-200">
              <div className=" absolute bottom-0 z-10 h-[50px] w-full bg-gradient-to-t from-[rgba(164,13,126,0.5)] to-[rgba(240,191,224,0.2)] pl-2   text-white">
              ...
              >
                <div className="overflow-hidden ">
                  <div
                    ...
                    className=" h-[225px] bg-cover bg-no-repeat transition-all duration-500 ease-in-out hover:scale-110"
                  ></div>
                </div>
              </a>
            </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-gray-900">
              <div className="relative bg-blue-200">
                <div className=" absolute bottom-0 z-10 h-[50px] w-full bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] pl-2  text-white">
                  おもてなし日本の代表する文化
                </div>
                <a
                ...
                >
                  <div className="overflow-hidden ">
                    <div
                      ...
                      className="  h-[225px]  bg-cover bg-center bg-no-repeat transition-all duration-500 ease-in-out hover:scale-110"
                    ></div>
                  </div>
                </a>
              </div>
      ...
      <div className=" mt-4 grid h-[450px] w-full grid-cols-2 gap-2">
        <div className="grid grid-rows-2 gap-2 ">
          <div className="bg-blue-50 ">
            <div className="relative bg-blue-200">
              <div className=" absolute bottom-0 z-10 h-[80px]  w-full bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] pl-2  text-white">
                <h1>神社仏閣</h1>
                <p>
              ...
              >
                <div className="overflow-hidden ">
                  <div
                    ...
                    className=" h-[230px] bg-cover bg-center bg-no-repeat transition-all duration-500 ease-in-out hover:scale-110"
                  ></div>
                </div>
              </a>
            </div>
        ...
        <div className="bg-blue-200 ">
          <div className="relative bg-blue-200">
            <div className=" absolute bottom-0 z-10 h-[100px] w-full bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] pl-2  text-white">
              <h1>日本食</h1>
              <p>
            ...
            >
              <div className="overflow-hidden ">
                <div
                  ...
                  className=" h-[470px] bg-cover bg-center bg-no-repeat transition-all duration-500 ease-in-out hover:scale-110"
                ></div>
              </div>
            </a>
          </div>
