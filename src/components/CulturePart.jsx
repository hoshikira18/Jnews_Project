    ...
    <div>
      <div className=" grid h-auto w-full grid-cols-1 gap-3 lg:h-[450px] lg:grid-cols-2 lg:gap-2 ">
        <div className="relative  bg-blue-200">
          <div className=" absolute bottom-0 z-10 h-[140px] w-full truncate bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] px-4 pl-3 pr-3 text-3xl text-white md:h-[110px] md:text-xl lg:h-[100px] lg:pl-2 lg:pr-2  lg:text-base">
            {t("content.title1")}
          </div>
          <a
        ...
        <div className="grid grid-rows-2 gap-3 lg:gap-2">
          <div className="bg-gray-900 ">
            <div className="relative h-[600px] w-full bg-blue-200 md:h-[400px] lg:h-auto">
              <div className=" absolute bottom-0 z-10 h-[100px] w-full truncate bg-gradient-to-t from-[rgba(164,13,126,0.5)] to-[rgba(240,191,224,0.2)] px-4 pl-4 text-3xl text-white md:h-[65px] md:text-xl lg:h-[50px] lg:pl-2  lg:text-base">
                {t("content.title2")}
              </div>
              <a
                className=""
          ...
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-gray-900">
              <div className="relative bg-blue-200">
                <div className=" absolute bottom-0 z-10 h-[100px] w-full  truncate bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] px-4 pl-2 text-3xl text-white md:h-[65px] md:text-xl lg:h-[50px]  lg:text-base">
                  {t("content.title3")}
                </div>
                <a
      ...
      <div className=" mt-4 grid h-auto w-full grid-cols-1 gap-3 lg:h-[450px] lg:grid-cols-2 lg:gap-2">
        <div className="grid grid-rows-2 gap-3 lg:gap-2 ">
          <div className="bg-blue-50 ">
            <div className="relative bg-blue-200">
              <div className="absolute bottom-0 z-10 h-[135px] w-full truncate bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] px-4 pl-4 text-3xl text-white md:h-[100px] md:text-xl lg:h-[80px] lg:pl-2  lg:text-base">
        ...
        <div className="bg-blue-200 ">
          <div className="relative bg-blue-200">
            <div className="absolute bottom-0 z-10 h-[155px] w-full truncate bg-gradient-to-t from-[rgba(20,10,87,0.5)] to-[rgba(96,96,138,0.2)] px-4 pl-3 pr-3 text-3xl text-white md:h-[135px] md:text-xl lg:h-[100px] lg:pl-2 lg:pr-2  lg:text-base">
              <h1 className=" text-4xl md:text-2xl lg:text-xl">
                {t("content.title8")}
              </h1>
